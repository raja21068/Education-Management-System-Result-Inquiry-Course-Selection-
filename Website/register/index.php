...
<tr>
	...
	echo("	<TD><select name='exam_year' id='exam_year' size='1' disabled='false'> ");
	...
	<td>	
	<?php
	echo("	<select name='batch_year' id='batch_year' size=1> ");
...
<tr>
	<td><B>Subject Code (Minimum Code 8 Digits)</B></td>
	<td>
	
		<input type='text' name='TEACHER_CODE' id='TEACHER_CODE'  placeholder="Enter Subject Code" required />
...
<tr>
	<td><B>Your Name</B></td>
	<td>	<select  name="STUDENT_CODE" id="STUDENT_CODE" size='1'  >

					<option value="">--Select NAME--</option>
						<?php
						display_teachers_in_combobox();
						echo("</select>");
?>
</td>
