...
================================================== -->
<meta charset="utf-8">
<title>University Of Sindh Examination Results</title>
	...
	<header id="header">
		...
		<div class="ten columns">
			<div id="logo">
				...
				<div id="tagline">University of Sindh </br><p style='font-size:22px;'> Directorate of Examinations</p></div>				
			</div>
		</div>
		...
		<div class="six columns">
			...
			<ul class="social-icons">
				...
				<li class="facebook"><a href="https://www.facebook.com/usindhexam" target="_blank">Facebook</a></li>
...
<ul class="menu" id="responsive">
	...
	<li><a href="http://usindh.edu.pk/" id="current"><i class="halflings white home"></i> Home</a></li>
		<li><a href="#" target="new">Results</a>
        <ul>
        	<li><a href="gazet.php">Gazette</a></li>
			<li><a href="announcements.php">Result Announcements</a></li>
			<li><a href="trancript.php">Marksheets</a></li>
			<li><a href="marksheet.php">Trancript</a></li>
			...
			<li><a href="unsuccessful_candidates.php">Unsuccessful Candidates</a></li>



        </ul>
		<li><a href="course_schemes.php">Course Scheme</a>
		<li><a href="facultyMembers.php">Faculty Staff</a>
		
		<!--
        </li>
		      <li><a href="#">Teachers Result </a>
			     	<ul>
      	  <li><a href="tl2/index.php/">Login</a></li>
      	  <li><a href="tl2/student_registration.php">Register</a></li>
			</ul>
        </li>
-->
      ...
      <li><a href="info.php">Contact Us</a>
