...
<form action='../online-exam-form/getgazet.php'>    
    <div class='col-md-4'>
...
<td>    <input type="text" name='rollNo' id='rollNo' class="form-control"  placeholder="i.e 2K10/CSE/60" required="required"></td>
	...
	?>
			...
			<tr><td colspan="2">	<input type="submit"  class="btn btn-primary"  value='SUBMIT'> <img src='../images/busy.gif' id='ajax-ico' style='display:none;'></td></tr>
			 

			</table>
			</form>
<Div><Font color='red'> Last Date Of sumbission Form 29 April 2016</div></FONT>
<Div><Font color='red'>  Date Of exam start on 9 May 2016</div></FONT>
<Div><Font color='red'> Note: Please get a print-out of Online Filled Form, attach Fresh ID Card  and submit by hand at the office of your concern department.</FONT>
 </div>
