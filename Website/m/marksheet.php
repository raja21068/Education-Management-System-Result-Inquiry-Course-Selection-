...
<div class="container floated">
  ...
  <div id="container" class="opacity">
	...
	echo("	<TD><input class='form-control' type=text name=roll_no size=10><FONT COLOR=RED SIZE=2> for example <U>2K10/CSE/60</U></TD>  ");
	echo("</TR>");
		echo(" <TR>");
		echo("	<TD ALIGN=RIGHT><B>Part</B></TD> ");
	
		echo(" <TD>");
	echo("		<select name=part size=1 class='form-control'> ");
